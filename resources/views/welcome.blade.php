    ...
    <head>
        ...
        <style>
            ...
            *,:after,:before{box-sizing:border-box;border:0 solid #e2e8f0}
            ...
            li>a>i:hover{color: #8C1F28} .bg-rojo{background-color: #8C1F28}
            video{max-width:100%;height:auto} .d-none{text-decoration: none}
            .bg-white{--bg-opacity:1;background-color:#fff;background-color:rgba(255,255,255,var(--bg-opacity))}
            .bg-dark{--bg-opacity:1;background-color: #1a202c;background-color: rgb(26, 32, 44)}
            .bg-gray-100{--bg-opacity:1;background-color:#4B4952;background-color:rgb(75, 73, 82)}
            ...
            .h-5{height:1.25rem}.h-8{height:2rem}.h-16{height:4rem}.text-sm{font-size:.875rem}.h-auto{height: auto}
            ...
            .text-gray-600{--text-opacity:1;color:#718096;color:rgba(113,128,150,var(--text-opacity))}.text-gray-700{--text-opacity:1;color:#4a5568;color:rgba(74,85,104,var(--text-opacity))}
            .text-gray-900{--text-opacity:1;color:#1a202c;color:rgba(26,32,44,var(--text-opacity))}.underline{text-decoration:underline}.antialiased{-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale}
            .w-5{width:1.25rem}.w-8{width:2rem}.w-10{width:4rem}.w-auto{width:auto}.grid-cols-1{grid-template-columns:repeat(1,minmax(0,1fr))}@media (min-width:640px){.sm\:rounded-lg{border-radius:.5rem}
            .sm\:block{display:block}.sm\:items-center{align-items:center}.sm\:justify-start{justify-content:flex-start}.sm\:justify-between{justify-content:space-between}.sm\:h-20{height:5rem}
                ...
                <div class="col-auto col-md-2 min-vh-100">
                    <div class="p">
                        ...
                        <ul class="nav nav-pills flex-column">
                            ...
                            <li class="nav-item pb">
                                <a href="#" class="nav-link text-gray-900">
                                    <i class="fa-solid fa-graduation-cap"></i><span class="fs-4 ml-2 d-sm-inline"></span>
                                </a>
                            </li>
                            <li class="nav-item pb">
                                <a href="#" class="nav-link text-gray-900">
                                    <i class="fa-solid fa-chalkboard-user"></i><span class="fs-4 ml-2 d-sm-inline"></span>
                                </a>
                            <li class="nav-item pb">
                                <a href="#" class="nav-link text-gray-900">
                                    <i class="fa-solid fa-user-shield"></i><span class="fs-4 ml-2 d-sm-inline"></span>
                                </a>
                            </li>
                            <li class="nav-item pb">
                                <a href="#" class="nav-link text-gray-900">
                            ...
                            <li class="nav-item pb">
                                <a href="#" class="nav-link text-gray-900">
                                    <i class="fa-solid fa-file-arrow-down"></i><span class="fs-4 ml-2 d-sm-inline"></span>
                                </a>
                            </li>
                            <li class="nav-item pb">
                                <a href="#" class="nav-link text-gray-900">
                                    <i class="fa-solid fa-clock-rotate-left"></i><span class="fs-4 ml-2 d-sm-inline"></span>
                                </a>
                            </li>
                        </ul>
                    </div>
