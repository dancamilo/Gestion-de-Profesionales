        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar navbar-dark panel">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="{{route('perfiles.index')}}" class="nav-item nav-link"><i class="fa-solid fa-address-book"></i></a>
                    <a href="{{route('usuarios.index')}}" class="nav-item nav-link"><i class="fa-solid fa-door-open"></i></a>
                    <a href="{{route('empresas.index')}}" class="nav-item nav-link"><i class="fa-solid fa-building"></i><a>
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            <span class="d-none d-lg-inline-flex">Cerrar sesión</span>
                        </a>
