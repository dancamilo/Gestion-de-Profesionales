...
<div class="d-flex w-100v mt-3">
    ...
    <div class="create-card w-25 me-4 p-4">
        ...
        <h5 class="text-left my-3">Área especializada</h5>
        <h5 class="text-left my-3">Perfiles</h5>
        <h5 class="text-left my-3">Curso 1</h5>
        <h5 class="text-left my-3">Curso 2</h5>
        <h5 class="text-left my-3">Curso 3</h5>
        <hr width="80%" class="mt-5">
        <h4 class="pt-3 mt-2">Horario disponible</h4>
        <div class="">
            <h5 class="text-left my-3">Lunes</h5>
            <h5 class="text-left my-3">Martes</h5>
            <h5 class="text-left my-3">Viernes</h5>
        </div>
        <div class="d-flex my-3">
